#
#  Be sure to run `pod spec lint EmbeddedJvm.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # If the EmbeddedJvm had special support for Thrift it would make sense to have a subspec.
  #s.default_subspec = 'Core'

  #s.subspec 'Core' do |cs|
  #  cs.source_files  = 'Classes', 'EmbeddedJvm/**/*.{h,m,mm}'
  #end
